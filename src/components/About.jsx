      ...
      <div className="flex flex-col items-center md:flex-row md:items-start md:gap-20">
        ...
        <div className="flex flex-col items-center md:items-start mt-10 text-gray-600">
          ...
          <p className="my-10 max-w-lg">
            ...
            molestias ab aliquam, porro facilis corrupti at veritatis quaerat
            officia doloribus ullam iure non atque hic totam illum iusto quo.
            Provident architecto et sequi ab repudiandae magnam doloremque nihil
            consequatur.
          </p>
